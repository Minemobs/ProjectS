package fr.minemobs.projects.entities;

import fr.minemobs.projects.init.ItemInit;
import fr.minemobs.projects.init.ModEntityType;
import fr.minemobs.projects.util.goal.StoneGrassGoal;
...
public class ProjectEntity extends AnimalEntity {

    public StoneGrassGoal stoneGrassGoal;
    private int exampleTimer;

    public ProjectEntity(EntityType<? extends AnimalEntity> type, World worldIn) {
        super(type, worldIn);
    }

    @Override
    public AgeableEntity createChild(AgeableEntity ageable) {
        ProjectEntity entity = new ProjectEntity(ModEntityType.PROJECT_ENTITY.get(), this.world);
    ...
    protected void registerGoals() {
        super.registerGoals();
        this.stoneGrassGoal = new StoneGrassGoal(this);
        this.goalSelector.addGoal(0, new SwimGoal(this));
        this.goalSelector.addGoal(1, new PanicGoal(this, 1.25D));
        this.goalSelector.addGoal(2, new BreedGoal(this, 1.0D));
        this.goalSelector.addGoal(3,
                new TemptGoal(this, 1.1D, Ingredient.fromItems(ItemInit.stonks_item.get()), false));
        this.goalSelector.addGoal(4, new FollowParentGoal(this, 1.1D));
        this.goalSelector.addGoal(5, this.stoneGrassGoal);
    ...
    protected void updateAITasks() {
        this.exampleTimer = this.stoneGrassGoal.getEatingGrassTimer();
        super.updateAITasks();
    }
