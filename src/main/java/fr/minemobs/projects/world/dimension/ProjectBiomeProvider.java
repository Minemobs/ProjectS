...
import fr.minemobs.projects.init.BiomeInit;
import net.minecraft.world.biome.Biome;
import net.minecraft.world.biome.Biomes;
import net.minecraft.world.biome.provider.BiomeProvider;

public class ProjectBiomeProvider extends BiomeProvider {
    private static final Set<Biome> biomeList = ImmutableSet.of(BiomeInit.PROJECT_BIOME.get(), Biomes.BEACH);
    private Random rand;
    private final double biomeSize = 16.0D;
    private VoronoiGenerator biomeNoise;

    public ProjectBiomeProvider(ProjectBiomeProviderSettings settings) {
        super(biomeList);
        rand = new Random();
