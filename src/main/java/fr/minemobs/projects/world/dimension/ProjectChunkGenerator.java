...
public class ProjectChunkGenerator extends NoiseChunkGenerator<ProjectGenSettings> {
    ...
    public ProjectChunkGenerator(IWorld worldIn, BiomeProvider provider, ProjectGenSettings settingsIn) {
