...
public class ProjectChestTileEntity extends LockableLootTileEntity {
	...
	public ProjectChestTileEntity(TileEntityType<?> typeIn) {
		super(typeIn);
	}
	...
	protected Container createMenu(int id, PlayerInventory player) {
		return new ProjectChestContainer(id, player, this);
	}
	...
	protected void onOpenOrClose() {
		...
		if (block instanceof ProjectChestBlock) {
	...
	public static int getPlayersUsing(IBlockReader reader, BlockPos pos) {
		...
		if (blockstate.hasTileEntity()) {
			...
			if (tileentity instanceof ProjectChestTileEntity) {
				return ((ProjectChestTileEntity) tileentity).numPlayersUsing;
			}
		}
		return 0;
	}

	public static void swapContents(ProjectChestTileEntity te, ProjectChestTileEntity otherTe) {
