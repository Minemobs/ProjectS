...
public class DoorBlock extends Block implements IWaterLoggable {
	   ...
	   public BlockState getStateForPlacement(BlockItemUseContext context) {
	      ...
	      else if (blockpos.getY() < 255 && context.getWorld().getBlockState(blockpos.up()).isReplaceable(context)) {
